...
addTestVariations(tests, 'qrRectFat', function(testOpts)
  if testOpts.tensorFunc():type() == 'torch.DoubleTensor' then
    ...
    local expected_q = testOpts.tensorFunc{
        {-9.667364890456631e-02,  9.077375936584360e-01,
          4.082482904638653e-01},
        {-4.833682445228317e-01,  3.157348151855452e-01,
         -8.164965809277254e-01},
        {-8.700628401410970e-01, -2.762679632873518e-01,
          4.082482904638621e-01}
    }
    local expected_r = testOpts.tensorFunc{
        {-1.034408043278860e+01, -1.179418516635709e+01,
         -1.324428989992559e+01, -1.469439463349408e+01},
        { 0.000000000000000e+00,  9.472044455566254e-01,
         1.894408891113255e+00,  2.841613336669887e+00},
        { 0.000000000000000e+00,  0.000000000000000e+00,
         1.554312234475219e-15,  4.440892098500626e-15},
    }
    checkQRWithExpected(testOpts, a, expected_q, expected_r)
  end
end, {doubleTensorOnly=true})
...
addTestVariations(tests, 'qrRectThin', function(testOpts)
  ...
  local expected_q = testOpts.tensorFunc{
      {-0.0776150525706334, -0.833052161400748 ,  0.5007372765119045},
      {-0.3104602102825332, -0.4512365874254053, -0.8330820982645458},
      {-0.5433053679944331, -0.0694210134500621,  0.1639523669933793},
      {-0.7761505257063329,  0.3123945605252804,  0.1683924547592624},
  }
  local expected_r = testOpts.tensorFunc{
      {-1.2884098726725126e+01, -1.4591629883279058e+01,
       -1.6299161039832992e+01},
      { 0.0000000000000000e+00, -1.0413152017509357e+00,
       -2.0826304035018706e+00},
      { 0.0000000000000000e+00,  0.0000000000000000e+00,
       1.1957467920563635e-15},
  }
  checkQRWithExpected(testOpts, a, expected_q, expected_r)
end, {doubleTensorOnly=true})
